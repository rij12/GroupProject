				...
				<form id="removeMember" method="post" action="includes/php/deleteMember.php">
					<div id = "membersInfoBodyMain">
						...
						<div id ="bodyRight">
							...
							<div class = "name"> <select name="userID">
								    <?php
										$sql = "SELECT * FROM members WHERE id <> '$id'";
										$result = mysqli_query($con,$sql);
										while($row = mysqli_fetch_array($result)) {	
							...
							?>><a href="#" onclick="document.getElementById('removeMember').submit();"><div id = "add" style = "margin-left: 100px; margin-top: 100px;"> Submit </div></a></div>
