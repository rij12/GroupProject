			...
			<div id ="body">
				...
				<div id = "membersInfoBodyMain">
					...
					<form enctype="multipart/form-data" action="updateMemberInfo.php" method = "post">
						...
						<div class = "name"> <input type="text" name="Name" maxlength="50" pattern="[a-zA-Z0-9 ]+" value="<?php echo $row['name']; ?>" required></div>
						...
						<div><input type="password" name="password" pattern="[a-zA-Z0-9 ]+" maxlength="50"></div>
